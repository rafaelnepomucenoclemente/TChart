...
MAPTSADDLETEMP CTChart::m_mapTSADDLETEMP;
...
void CTChart::InitTSKILLTEMP( CString strPath )
{
	...
	for( WORD i=0; i<wCount; i++)
	{
		...
		/*	if(i == 17 && pTSKILL->m_fMaxRange != 2.0f||i == 18 && pTSKILL->m_fMaxRange != 20||pTSKILL->m_fMinRange != 3 && i == 18||i == 19 && pTSKILL->m_fMaxRange != 22 || pTSKILL->m_fMinRange != 3 && i == 19||i==20 && pTSKILL->m_fMaxRange != 21 || i == 22 && pTSKILL->m_fMaxRange != 20|| i == 22 && pTSKILL->m_fMinRange != 5|| i == 22 && pTSKILL->m_dwSpellTick != 200|| i == 24 && pTSKILL->m_fMaxRange != 3 || i == 33 && pTSKILL->m_fMaxRange != 2 || i == 34 && pTSKILL->m_fMaxRange !=2 || i == 35 && pTSKILL->m_fMaxRange != 3 || i == 36 && pTSKILL->m_fMaxRange != 8 || i == 37 && pTSKILL->m_fMaxRange != 2 || i == 38 && pTSKILL->m_fMaxRange != 2 || i == 39 && pTSKILL->m_fMaxRange != 2|| i == 39 && pTSKILL->m_dwSpellTick != 200|| i == 40 && pTSKILL->m_fMaxRange != 2 || i == 41 && pTSKILL->m_fMaxRange != 2 || i == 42 && pTSKILL->m_fMaxRange != 4 || i == 43 && pTSKILL->m_fMaxRange != 2|| i == 45 && pTSKILL->m_fMaxRange != 2 || i == 46 && pTSKILL->m_fMaxRange != 2 || i == 47 && pTSKILL->m_fMaxRange != 2|| i == 47 && pTSKILL->m_dwSpellTick != 200 || i == 48 && pTSKILL->m_fMaxRange != 2 || i == 48 && pTSKILL->m_dwSpellTick != 500|| í == 51 && pTSKILL->m_fMaxRange != 2|| i == 52 && pTSKILL->m_fMaxRange != 2 || i == 53 && pTSKILL->m_fMaxRange != 2 || i == 53 && pTSKILL->m_dwSpellTick != 200|| i== 55 && pTSKILL->m_fMaxRange != 2|| i == 56 && pTSKILL->m_fMaxRange != 2 || i == 56 && pTSKILL->m_dwSpellTick != 200||i==57 && pTSKILL->m_fMaxRange != 2||i == 58 && pTSKILL->m_fMaxRange != 2 || i == 58 && pTSKILL->m_dwSpellTick != 200||i==59 || pTSKILL->m_fMaxRange != 8 || i == 59 && pTSKILL->m_fAtkRange != 8||i==60 && pTSKILL->m_fMaxRange != 2|| i == 60 && pTSKILL-)
			{
				MessageBox(NULL,"TCD Files were changed!","Error",MB_ICONEXCLAMATION);
            exit(1);
			}
*/
			CString test;
			/*if(i == 46 && pTSKILL->m_bRangeType != 4|| i == 47 && pTSKILL->m_bRangeType != 4|| i == 49 && pTSKILL->m_bRangeType != 4|| i == 59 && pTSKILL->m_bRangeType != 4|| i == 60 && pTSKILL->m_bRangeType != 4|| i == 78 && pTSKILL->m_bRangeType != 4|| i == 101 && pTSKILL->m_bRangeType != 4|| i == 105 && pTSKILL->m_bRangeType != 7|| i == 108 && pTSKILL->m_bRangeType != 4|| i == 120 && pTSKILL->m_bRangeType != 4|| i == 121 && pTSKILL->m_bRangeType != 4|| i == 130 && pTSKILL->m_bRangeType != 4|| i == 145 && pTSKILL->m_bRangeType != 4|| i == 168 && pTSKILL->m_bRangeType != 4|| i == 172 && pTSKILL->m_bRangeType != 4|| i == 173 && pTSKILL->m_bRangeType != 4|| i == 186 && pTSKILL->m_bRangeType != 6|| i == 187 && pTSKILL->m_bRangeType != 5|| i == 200 && pTSKILL->m_bRangeType != 4|| i == 209 && pTSKILL->m_bRangeType != 4|| i == 213 && pTSKILL->m_bRangeType != 4|| i == 223 && pTSKILL->m_bRangeType != 4|| i == 302 && pTSKILL->m_bRangeType != 4|| i == 303 && pTSKILL->m_bRangeType != 4|| i == 304 && pTSKILL->m_bRangeType != 4|| i == 307 && pTSKILL->m_bRangeType != 4|| i == 308 && pTSKILL->m_bRangeType != 4|| i == 315 && pTSKILL->m_bRangeType != 4|| i == 316 && pTSKILL->m_bRangeType != 4|| i == 318 && pTSKILL->m_bRangeType != 4|| i == 319 && pTSKILL->m_bRangeType != 4|| i == 320 && pTSKILL->m_bRangeType != 4|| i == 325 && pTSKILL->m_bRangeType != 4|| i == 326 && pTSKILL->m_bRangeType != 4|| i == 327 && pTSKILL->m_bRangeType != 4|| i == 328 && pTSKILL->m_bRangeType != 4|| i == 329 && pTSKILL->m_bRangeType != 4|| i == 341 && pTSKILL->m_bRangeType != 4|| i == 342 && pTSKILL->m_bRangeType != 4|| i == 344 && pTSKILL->m_bRangeType != 4|| i == 345 && pTSKILL->m_bRangeType != 4|| i == 347 && pTSKILL->m_bRangeType != 4|| i == 353 && pTSKILL->m_bRangeType != 4|| i == 355 && pTSKILL->m_bRangeType != 4|| i == 356 && pTSKILL->m_bRangeType != 4|| i == 359 && pTSKILL->m_bRangeType != 4|| i == 360 && pTSKILL->m_bRangeType != 4|| i == 361 && pTSKILL->m_bRangeType != 4|| i == 362 && pTSKILL->m_bRangeType != 4|| i == 363 && pTSKILL->m_bRangeType != 4|| i == 364 && pTSKILL->m_bRangeType != 4|| i == 365 && pTSKILL->m_bRangeType != 4|| i == 366 && pTSKILL->m_bRangeType != 4|| i == 380 && pTSKILL->m_bRangeType != 4|| i == 381 && pTSKILL->m_bRangeType != 4|| i == 382 && pTSKILL->m_bRangeType != 4|| i == 383 && pTSKILL->m_bRangeType != 4|| i == 384 && pTSKILL->m_bRangeType != 4|| i == 537 && pTSKILL->m_bRangeType != 4|| i == 542 && pTSKILL->m_bRangeType != 4|| i == 543 && pTSKILL->m_bRangeType != 4|| i == 544 && pTSKILL->m_bRangeType != 4|| i == 545 && pTSKILL->m_bRangeType != 4|| i == 546 && pTSKILL->m_bRangeType != 4|| i == 547 && pTSKILL->m_bRangeType != 4|| i == 548 && pTSKILL->m_bRangeType != 4|| i == 549 && pTSKILL->m_bRangeType != 4|| i == 550 && pTSKILL->m_bRangeType != 4|| i == 551 && pTSKILL->m_bRangeType != 4|| i == 554 && pTSKILL->m_bRangeType != 4|| i == 555 && pTSKILL->m_bRangeType != 4|| i == 556 && pTSKILL->m_bRangeType != 4|| i == 559 && pTSKILL->m_bRangeType != 4|| i == 560 && pTSKILL->m_bRangeType != 4|| i == 561 && pTSKILL->m_bRangeType != 4|| i == 562 && pTSKILL->m_bRangeType != 4|| i == 563 && pTSKILL->m_bRangeType != 4|| i == 564 && pTSKILL->m_bRangeType != 4|| i == 571 && pTSKILL->m_bRangeType != 4|| i == 574 && pTSKILL->m_bRangeType != 4|| i == 575 && pTSKILL->m_bRangeType != 4|| i == 576 && pTSKILL->m_bRangeType != 4|| i == 577 && pTSKILL->m_bRangeType != 4|| i == 580 && pTSKILL->m_bRangeType != 4|| i == 601 && pTSKILL->m_bRangeType != 5|| i == 605 && pTSKILL->m_bRangeType != 7|| i == 608 && pTSKILL->m_bRangeType != 4|| i == 614 && pTSKILL->m_bRangeType != 4|| i == 632 && pTSKILL->m_bRangeType != 5|| i == 651 && pTSKILL->m_bRangeType != 7|| i == 654 && pTSKILL->m_bRangeType != 4|| i == 655 && pTSKILL->m_bRangeType != 4|| i == 672 && pTSKILL->m_bRangeType != 5|| i == 686 && pTSKILL->m_bRangeType != 7|| i == 690 && pTSKILL->m_bRangeType != 5|| i == 704 && pTSKILL->m_bRangeType != 7)
 {
	 	test.Format("ID : %d",pTSKILL->m_wSkillID);
				MessageBox(NULL,test,"Error",MB_ICONEXCLAMATION);
            exit(1);
 }
*/
...
void CTChart::InitTITEMTEMP( CString strPath )
{
	...
	for( WORD i=0; i<wCount; i++)
	{
		...
		ar	>> pTITEM->m_wItemID				///ÀÏ·Ã¹øÈ£
			...
			>> pTITEM->m_bDestoryProb			///¼Ò¸ê¿©ºÎ(Ãß°¡)
			>> useless
			>> useless
...
void CTChart::InitTSADDLETEMP( CString strPath )
{
	ReleaseTSADDLETEMP();
	...
	for( WORD i=0; i<wCount; i++)
	{
		...
		CTChart::m_mapTSADDLETEMP.insert( MAPTSADDLETEMP::value_type( pSaddle->m_wNoSaddle, pSaddle));

	}
}

void CTChart::ReleaseTSADDLETEMP()
{
	MAPTSADDLETEMP::iterator itTSADDLE;

	for( itTSADDLE = CTChart::m_mapTSADDLETEMP.begin(); itTSADDLE != CTChart::m_mapTSADDLETEMP.end(); itTSADDLE++)
		delete (*itTSADDLE).second;

	CTChart::m_mapTSADDLETEMP.clear();
}

LPTSADDLE CTChart::FindTSADDLETEMP( WORD wNoSaddleID)
{
	MAPTSADDLETEMP::iterator finder = CTChart::m_mapTSADDLETEMP.find(wNoSaddleID);

	if( finder != CTChart::m_mapTSADDLETEMP.end() )
		return (*finder).second;
...
LPTTITLE CTChart::FindTTITLETEMP( WORD wTitleID)
{
	MAPTTITLETEMP::iterator finder = CTChart::m_mapTTITLETEMP.find(wTitleID);
