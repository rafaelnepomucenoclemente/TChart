...
public:
	...
	static void InitTTITLETEMP( CString strPath );
		static void InitTSADDLETEMP( CString strPath );
	static void ReleaseTTITLETEMP();
		static void ReleaseTSADDLETEMP();
		static LPTSADDLE FindTSADDLETEMP( WORD wNoSaddleID);
	static LPTTITLE FindTTITLETEMP( WORD wTitleID);
...
public:
	...
	static MAPTTITLETEMP m_mapTTITLETEMP;
		static MAPTSADDLETEMP m_mapTSADDLETEMP;
